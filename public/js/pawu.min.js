...
{nav.removeClass('active');content.removeClass('active');}});}})();$(document).ready(function()
...
{return function(){var tx=new PlugAuth.Client.Tx();setTimeout(function(){tx.success(fake_data,fake_status)},1);return tx;};}
...
PlugAuth.Client.Tx.prototype.error=function(aFunction){this.error_cb=aFunction;return this}})();if(PlugAuth===undefined)var PlugAuth={};if(PlugAuth.UI===undefined)PlugAuth.UI={};(function()
...
{return page.client.can('change_password','user/'+page.client.user)}});if(PlugAuth===undefined)var PlugAuth={};if(PlugAuth.UI===undefined)PlugAuth.UI={};(function(){var VERSION='dev';VERSION='0.02';PlugAuth.UI.NAME='PlugAuth WebUI';PlugAuth.UI.VERSION=VERSION;})();PlugAuth.UI.bind_enter=function(input,callback){input.keypress(function(event){if(event.which==10||event.which==13)
...
$(document).ready(function(){PlugAuth.UI.error_modal=new PlugAuth.UI.Modal('Error');PlugAuth.UI.notice_modal=new PlugAuth.UI.Modal('Notice');PlugAuth.UI.data=JSON.parse($('#plugauth_webui_data').val());if(PlugAuth.UI.data.requires_authentic_credentials==1)
{PlugAuth.UI.login.enable();}
else
{var client=new PlugAuth.Client(PlugAuth.UI.data.api_url);client.can=PlugAuth.Client.create_fake_method('ok',200);PlugAuth.UI.setup(client);}});if(PlugAuth===undefined)var PlugAuth={};if(PlugAuth.UI===undefined)PlugAuth.UI={};(function()
...
page.order=20;});if(PlugAuth===undefined)var PlugAuth={};if(PlugAuth.UI===undefined)PlugAuth.UI={};if(PlugAuth.UI.Menu===undefined)PlugAuth.UI.Menu={};(function()
